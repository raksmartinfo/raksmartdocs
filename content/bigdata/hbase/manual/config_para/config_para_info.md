...
|   petaexpress.hbase.major.compact.hour      |  -1～24       |   表示设置每天手动 Major Compaction 的整点时间，设为-1则取消手动 Compaction。  |
|   petaexpress.phoenix.on.hbase.enable  |   - |  表示是否开启 Phoenix 查询引擎功能。  |
