...
Ubuntu: `http://mirrors.ks.petaexpress.com`
支持区域:
  * 北京3区
...
```
sudo sed -i s/us.archive.ubuntu.com/mirrors.ks.petaexpress.com/g /etc/apt/sources.list
sudo sed -i s/cn.archive.ubuntu.com/mirrors.ks.petaexpress.com/g /etc/apt/sources.list
sudo sed -i s/security.ubuntu.com/mirrors.ks.petaexpress.com/g /etc/apt/sources.list
sudo apt-get update
```
