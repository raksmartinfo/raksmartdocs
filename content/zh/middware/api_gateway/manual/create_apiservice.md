...
keyword: API_Gateway, PetaExpress, API 服务
draft: false
weight: 30
---
...
> **说明**
>
> 若下拉中无 DNS 域名可选，请进入[PetaExpress 管理控制台](https://console.petaexpress.com/login)点击 **域名与网站** > **云解析 DNS**，新建 DNS 域名，操作流程可参考：[云解析 DNS](../../../../../site/dns/quickstart/creatgslbpolicy/)。
>
> 若用户不绑定域名，服务会默认被绑定一个以 `apig.petaexpress.com` 为后缀的域名，绑定新的域名后，域名数据刷新。
>
