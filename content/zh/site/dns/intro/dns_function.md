...
PetaExpress DNS 支持七种标准解析类型，包括 A、CNAME、AAAA、MX、NS、TXT 和 PTR。
...
PetaExpress DNS 还以解析类型的方式扩展实现301跳转、302跳转及隐性跳转功能。

### 解析模式

PetaExpress DNS 提供四种解析模式：**普通模式**、**轮询模式**、**权重模式**和**智能模式**，以应对不同业务场景的负载均衡需求。
