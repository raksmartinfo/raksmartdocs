...
weight: 6
collapsible: false
keyword: 秘钥签名, PetaExpress, , 签名方法, API
...
您需要先在控制台创建[API密钥](https://console.petaexpress.com/access_keys/)，获得 accesss_key_id 和 secret_access_key，这里我们假设
...
```
{
  ...
  "login_mode":"passwd",
  "login_passwd":"PetaExpress20130712",
  "version":1,
  "access_key_id":"QYACCESSKEYIDEXAMPLE",
  "action":"RunInstances",
...
```
access_key_id=QYACCESSKEYIDEXAMPLE&action=RunInstances&count=1&image_id=centos64x86a&instance_name=demo&instance_type=small_b&login_mode=passwd&login_passwd=PetaExpress20130712&signature_method=HmacSHA256&signature_version=1&time_stamp=2013-08-27T14%3A30%3A10Z&version=1&vxnets.1=vxnet-0&zone=pek3a
```
...
```
https://api.petaexpress.com/iaas/?access_key_id=QYACCESSKEYIDEXAMPLE&action=RunInstances&count=1&image_id=centos64x86a&instance_name=demo&instance_type=small_b&login_mode=passwd&login_passwd=PetaExpress20130712&signature_method=HmacSHA256&signature_version=1&time_stamp=2013-08-27T14%3A30%3A10Z&version=1&vxnets.1=vxnet-0&zone=pek3a&signature=byjccvWIvAftaq%2BoublemagH3bYAlDWxxLFAzAsyslw%3D
```
...
这里我们假设您的 API 执行设备为 PetaExpress 广东 2 区 id 为 i-7lchv5u3 的云服务器：
...
```
https://api.petaexpress.com/iam/?access_key_id=0z7dO3oN03byx1CepBDTyl
